# Extracted from https://raw.githubusercontent.com/pytorch/torchtitan/main/torchtitan/models/common/rope.py on 2026-05-23
# Contents: RoPE class (Module subclass with Config), _precompute_complex, _precompute_cos_sin,
#           _reshape_for_broadcast_complex, _reshape_for_broadcast_cos_sin, _rotate_half,
#           _maybe_wrap_positions, apply_rotary_emb_complex, apply_rotary_emb_single_complex,
#           apply_rotary_emb_cos_sin
# NOTE: Partial extract. Original file is the shared RoPE module used by Llama3/4, DeepSeek V3,
#       Qwen3, and GPT-OSS in TorchTitan. The Llama3 model file
#       (torchtitan/models/llama3/model.py) no longer contains RoPE inline — it now references
#       this shared module via a `rope` config field. This file is the canonical source.
