...
| v6_sync | 337.7 | 737.0 | 801.9 | 512.0 | 1.00x | 1.00x |
| v6_streams | 337.7 | 737.0 | 801.9 | 512.0 | 1.00x | 1.00x |
...
| v6_sync | 337.7 | 184.4 | 201.8 | 128.0 | 1.00x | 1.00x |
| v6_streams | 337.7 | 184.4 | 201.8 | 128.0 | 1.00x | 1.00x |
| v5_inference (pre-merged) | 336.0 | 184.0 | — | 16.0 | 1.00x | — |

## LLaMA-8B small-M (batch=1, seq=512, r=16, bf16)

`batch=1, seq=512, H=4096, I=14336, r=16, bfloat16`

| Implementation | Weights (MB) | Fwd (MB) | Fwd+Bwd (MB) | Resident after fwd (MB) | vs Unsloth Fwd | vs Unsloth Bwd |
|---|---:|---:|---:|---:|---:|---:|
| Unsloth | 337.7 | 46.0 | 51.7 | 32.0 | 1.00x | 1.00x |
| v3 | 337.7 | 74.0 | 74.0 | 32.0 | 1.61x | 1.43x |
| v5 | 337.7 | 414.7 | 414.7 | 32.0 | 9.01x | 8.02x |
| v5_upgrade_1 | 337.7 | 300.1 | 300.1 | 32.0 | 6.52x | 5.80x |
| v6_sync | 337.7 | 46.3 | 51.7 | 32.0 | 1.01x | 1.00x |
| v6_streams | 337.7 | 46.3 | 51.7 | 32.0 | 1.01x | 1.00x |
| v5_inference (pre-merged) | 336.0 | 46.0 | — | 4.0 | 1.00x | — |
...
| v6_sync | 527.1 | 230.5 | 252.2 | 160.0 | 1.00x | 1.00x |
| v6_streams | 527.1 | 230.5 | 252.2 | 160.0 | 1.00x | 1.00x |
...
| v6_sync | 336.8 | 736.5 | 801.0 | 512.0 | 1.00x | 1.00x |
| v6_streams | 336.8 | 736.5 | 801.0 | 512.0 | 1.00x | 1.00x |
| v5_inference (pre-merged) | 336.0 | 736.0 | — | 64.0 | 1.00x | — |
...
| v6_sync | 339.4 | 738.0 | 803.9 | 512.0 | 1.00x | 1.00x |
| v6_streams | 339.4 | 738.0 | 803.9 | 512.0 | 1.00x | 1.00x |
| v5_inference (pre-merged) | 336.0 | 736.0 | — | 64.0 | 1.00x | — |
...
| v6_sync | 342.8 | 740.0 | 807.8 | 512.0 | 1.00x | 1.00x |
| v6_streams | 342.8 | 740.0 | 807.8 | 512.0 | 1.00x | 1.00x |
| v5_inference (pre-merged) | 336.0 | 736.0 | — | 64.0 | 1.00x | — |
